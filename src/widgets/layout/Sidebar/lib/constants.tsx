...
export const NAV_ITEMS = [
  ...
  { label: 'Календарь', icon: <CalendarIcon />, to: '/calendar' },
  { label: 'Команда', icon: <PersonIcon />, to: '/team' },
];

export const FILTERS = [
  { label: 'Все задачи', icon: <ListBulletIcon /> },
  { label: 'Высокий приоритет', icon: <ExclamationTriangleIcon /> },
  { label: 'Просроченные', icon: <StopwatchIcon /> },
  { label: 'Мои задачи', icon: <PersonIcon /> },
];

export const STATS: { label: string; value: number; color: BadgeProps['color'] }[] = [
